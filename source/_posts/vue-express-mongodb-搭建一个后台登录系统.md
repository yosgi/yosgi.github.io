...
![image](vue-express-mongodb-搭建一个后台登录系统/1.png)

[mongodb](https://www.mongodb.com/) , [adminMongo](https://github.com/mrvautin/adminMongo)(非必须)

![image](vue-express-mongodb-搭建一个后台登录系统/2.png)

![image](vue-express-mongodb-搭建一个后台登录系统/3.png)
...
![image](vue-express-mongodb-搭建一个后台登录系统/4.png)
...
![image](vue-express-mongodb-搭建一个后台登录系统/5.png)
...
![image](vue-express-mongodb-搭建一个后台登录系统/6.png)

就能启动express应用了

![image](vue-express-mongodb-搭建一个后台登录系统/7.png)
...
我们事先在数据库做好了admin用户
![image](vue-express-mongodb-搭建一个后台登录系统/8.png)

请求结果

![image](vue-express-mongodb-搭建一个后台登录系统/9.png)

![image](vue-express-mongodb-搭建一个后台登录系统/10.png)
