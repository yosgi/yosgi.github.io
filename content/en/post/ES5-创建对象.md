...
dog.food` and `cat.food` obviously share an object on the prototype, and it is a reference type. Then modifying this food in the instance will cause changes in food in other instances.
