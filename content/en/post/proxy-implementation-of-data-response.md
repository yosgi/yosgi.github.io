...
description: Rebuilding Vue-style reactive data binding with ES6 Proxy, and why it handles arrays and nested objects more cleanly than Object.defineProperty.
draft: false
categories:
  - JavaScript
tags:
...
I have previously used Object.defineProperty and closures to accomplish this task — see [Observer mode and Vue monitoring object changes](/en/post/observer-mode-and-vue-monitoring-object-changes/).

After learning about ES6 Proxy, I wanted to use a proxy instead — see [Proxy (ES6)](/en/post/proxy/).
